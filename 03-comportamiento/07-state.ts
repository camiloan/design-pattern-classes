...
class DispensingProduct implements State {
    public name = 'Despachando producto';
    private vendingMachine: VendingMachine;
    ...
    dispenseProduct(): void {
        console.log('%cProducto despachado, cambiando estado a Esperando dinero.', COLORS.red)
...
async function main() {
    ...
    do {
        console.clear();
        console.log(`Selecciona una opción ${vendingMachine.getStateName()}`, COLORS.green);
